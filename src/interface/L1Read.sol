...
contract L1Read {
  ...
  function position(address user, uint16 perp) external view virtual returns (Position memory) {
    bool success;
    bytes memory result;
  ...
  function spotBalance(address user, uint64 token) external view virtual returns (SpotBalance memory) {
    bool success;
    bytes memory result;
  ...
  function userVaultEquity(
    address user,
    address vault
  ) external view virtual returns (UserVaultEquity memory) {
    bool success;
    bytes memory result;
  ...
  function withdrawable(address user) external view virtual returns (Withdrawable memory) {
    bool success;
    bytes memory result;
  ...
  function delegations(address user) external view virtual returns (Delegation[] memory) {
    bool success;
    bytes memory result;
  ...
  function delegatorSummary(address user) external view virtual returns (DelegatorSummary memory) {
    bool success;
    bytes memory result;
  ...
  function markPx(uint32 index) external view virtual returns (uint64) {
    bool success;
    bytes memory result;
  ...
  function oraclePx(uint32 index) external view virtual returns (uint64) {
    bool success;
    bytes memory result;
  ...
  function spotPx(uint32 index) external view virtual returns (uint64) {
    bool success;
    bytes memory result;
  ...
  function l1BlockNumber() external view virtual returns (uint64) {
    bool success;
    bytes memory result;
  ...
  function perpAssetInfo(uint32 perp) external view virtual returns (PerpAssetInfo memory) {
    bool success;
    bytes memory result;
  ...
  function spotInfo(uint32 spot) external view virtual returns (SpotInfo memory) {
    bool success;
    bytes memory result;
  ...
  function tokenInfo(uint32 token) external view virtual returns (TokenInfo memory) {
    bool success;
    bytes memory result;
  ...
  function tokenSupply(uint32 token) external view virtual returns (TokenSupply memory) {
    bool success;
    bytes memory result;
  ...
  function bbo(uint32 asset) external view virtual returns (Bbo memory) {
    bool success;
    bytes memory result;
  ...
  function accountMarginSummary(
    ...
    address user
  ) external view virtual returns (AccountMarginSummary memory) {
    bool success;
    bytes memory result;
  ...
  function coreUserExists(address user) external view virtual returns (CoreUserExists memory) {
    bool success;
    bytes memory result;
